...
#'''
#'''
UNFILTERED_FILE = "/private/home/belindali/starsem2018-entity-linking/data/{}/input/{}.train.entities.all_pos.json".format(sn, prefix)
FILTERED_FILE = "/private/home/belindali/starsem2018-entity-linking/data/{}/input/{}.train.entities.all_pos.filtered_on_all.no_partials.json".format(sn, prefix)
